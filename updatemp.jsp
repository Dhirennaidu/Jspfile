        ...
        <div class="container">
            ...
            <div class="sidebar">
                <ul>
                    ...
                    <li><span><a href="manage.jsp"><button style="background-color:green;width:200px;height:40px;color:white">Manage Employe</button></a></li>
            ...
            <div class="mainarea">
               ...
               ResultSet rs=smt.executeQuery("select * from emp where P_id="+data);
              ...
              // String id=request.getParameter("id1");
               ...
               String Adar=request.getParameter("adar");
               if(Name == null){
               ...
               else
               {
               	  try{
                         ...
                         PreparedStatement st=conn2.prepareStatement("update emp set P_name=?,P_email=?, P_mobile=?, P_adar=? where  P_id="+data);
               ...
               %>
                 <tr>
                    <td><%=  rs.getInt(1)  %></td>
                    <form method="post">
                    <td><input type="text"  value="<%= rs.getString(2)  %>" name="name" required></td>
                   
                   
                    <td><input type="text" value="<%= rs.getString(3)  %>" name="email"required></td>
                    
                    <td><input type="text"  value="<%= rs.getString(4)  %>" name="mobileno"required></td>
                    
                 
                    
                    <td><input type="text" value="<%= rs.getString(6) %>" name="adar"required></td>
                    <td>
