    ...
    <body>
        <div class="container">
            ...
            <div class="mainarea">
               ...
               ResultSet rs=smt.executeQuery("select * from emp where A_email='"+session.getAttribute("email").toString()+"'");
               ...
               %>
                 <tr>
                    ...
                    <%int data=rs.getInt(1); %>
                       <a href="delete.jsp?id=<%= rs.getInt(1) %>" > <button style="background-color: red;color:white;height: 30px;width:60px;border-radius:10px;">Delete</button></a>
                        <a href="updatemp.jsp?id1=<%= rs.getInt(1) %>" ><button style="background-color: rgb(15, 70, 249);color:white;height: 30px;width:60px;border-radius:10px;">Edit</button>
                    </td>
                 </tr>
                      <%
                }
